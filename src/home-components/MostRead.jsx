...
function MostRead() {
    ...
    {title: '文章標題 文章標題 文章標題', cPercent: 50, pPercent: 50, sentiment: 'positive', sources: '10 個來源'}, 
    {title: '特朗普不確定性中，中國贏得東南亞朋友的“最佳時機”？', cPercent: 35, pPercent: 65, sentiment: 'default', sources: '21 個來源'},
    {title: '香港旅遊事務署長在大型活動中出現混亂後提出電子票務想法', cPercent: 49, pPercent: 51, sentiment: 'default', sources: '16 個來源'},
    {title: '科技戰：中國頂級晶圓代工廠中芯國際2024年收入增長，但淨利潤大幅下降', cPercent: 70, pPercent: 30, sentiment: 'default', sources: '19 個來源'},
    {title: '國際滑冰聯盟對世界錦標賽上展示台灣而非中華台北旗表示歉意', cPercent: 42, pPercent: 58, sentiment: 'default', sources: '21 個來源'}
    ];

    const mostReadArticles_zhs = [
    {title: '文章标题 文章标题 文章标题', cPercent: 50, pPercent: 50, sentiment: 'positive', sources: '10 个来源'},         
    {title: '川普不确定性中，中国赢得东南亚朋友的“最佳时机”？', cPercent: 35, pPercent: 65, sentiment: 'default', sources: '21 个来源'},
    {title: '香港旅游事务署长在大型活动中出现混乱后提出电子票务想法', cPercent: 49, pPercent: 51, sentiment: 'default', sources: '16 个来源'},
    {title: '科技战：中国顶级晶圆代工厂中芯国际2024年收入增长，但净利润大幅下降', cPercent: 70, pPercent: 30, sentiment: 'default', sources: '19 个来源'},  
    {title: '国际滑冰联盟对世界锦标赛上展示台湾而非中华台北旗表示歉意', cPercent: 42, pPercent: 58, sentiment: 'default', sources: '21 个来源'}
    ];
    ...
    return (
      ...
      <div className="relative w-9/10 flex-grow flex-col justify-start items-start mx-auto px-2 pt-2 pb-8">
        <h2 className="font-bold mt-2 mb-6">
            {language === 'zh-Hant' ? '最受歡迎' : language === 'zh-Hans' ? '最受欢迎' : 'Most Read'}
        </h2>
